...
func (ec *executionContext) _Query_listAccounts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Account)
	fc.Result = res
	return ec.marshalNAccount2ᚕᚖwazaᚋgraphᚐAccountᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAccount2ᚕᚖwazaᚋgraphᚐAccountᚄ(ctx context.Context, sel ast.SelectionSet, v []*Account) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNAccount2ᚖwazaᚋgraphᚐAccount(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNAccount2ᚖwazaᚋgraphᚐAccount(ctx context.Context, sel ast.SelectionSet, v *Account) graphql.Marshaler {
	if v == nil {
